<x-layouts.app title="Admin - Gestion des Animations">
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="flex items-center justify-between mb-8">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('admin.create-animation') }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg transition flex items-center gap-2">
            ...
            <div class="grid grid-cols-4 gap-4 mb-6">
                <div class="bg-white rounded-xl p-4 shadow">
                    <p class="text-2xl font-black text-soboa-blue">{{ $stats['total'] }}</p>
                ...
                <div class="bg-white rounded-xl p-4 shadow">
                    <p class="text-2xl font-black text-orange-600">{{ $stats['upcoming'] }}</p>
                    <p class="text-gray-500 text-sm">À venir</p>
                </div>
                <div class="bg-white rounded-xl p-4 shadow">
                    <p class="text-2xl font-black text-gray-600">{{ $stats['past'] }}</p>
                    <p class="text-gray-500 text-sm">Passées</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="text-left p-4 font-bold text-gray-700">Point de vente</th>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        @if($animation->bar->zone)
                                            <div class="text-xs text-gray-500">{{ $animation->bar->zone }}</div>
                                        @endif
                                    </div>
                                </div>
                            </td>
