        ...
        <div class="max-w-md w-full">
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div class="text-center mb-8">
                    <div class="w-20 h-20 bg-gradient-to-br from-soboa-orange to-orange-400 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                ...
                <div id="step-otp" style="display: none;">
                    ...
                    <div class="mt-4 text-center">
                        <button type="button" id="back-btn" class="text-soboa-blue hover:underline text-sm font-semibold">
                            ← Modifier le numéro
                        </button>
                    </div>
                </div>
